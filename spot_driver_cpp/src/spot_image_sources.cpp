...
static const std::map<ImageSource, std::string> kImageSourceToAPISourceName = [](){
  ...
  {
    out.try_emplace(ImageSource{entry, SpotImageType::RGB}, bosdyn::client::GetFisheyeImageName(kSpotCameraToSdkBodyCamera.at(entry)));
    out.try_emplace(ImageSource{entry, SpotImageType::DEPTH}, bosdyn::client::GetDepthName(kSpotCameraToSdkBodyCamera.at(entry)));
    out.try_emplace(ImageSource{entry, SpotImageType::DEPTH_REGISTERED}, bosdyn::client::GetDepthInVisualName(kSpotCameraToSdkBodyCamera.at(entry)));
  }
  ...
  out.try_emplace(ImageSource{SpotCamera::HAND, SpotImageType::DEPTH_REGISTERED}, bosdyn::client::kHandDepthInHandColorFrame);
  return out;
}();
