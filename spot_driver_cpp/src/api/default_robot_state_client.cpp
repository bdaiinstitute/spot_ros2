...
spot_msgs::msg::BatteryStateArray GetBatteryStates(const ::bosdyn::api::RobotState &robot_state, const google::protobuf::Duration& clock_skew){
...
spot_msgs::msg::EStopStateArray GetEstopStates(const ::bosdyn::api::RobotState &robot_state, const google::protobuf::Duration& clock_skew){
...
std::optional<sensor_msgs::msg::JointState> GetJointStates(const ::bosdyn::api::RobotState &robot_state, const google::protobuf::Duration& clock_skew, const std::string &prefix){
  if(robot_state.has_kinematic_state()){
    sensor_msgs::msg::JointState joint_states;
    joint_states.header.stamp = spot_ros2::applyClockSkew(robot_state.kinematic_state().acquisition_timestamp(), clock_skew);
...
std::optional<tf2_msgs::msg::TFMessage> GetTf(const ::bosdyn::api::RobotState &robot_state, const google::protobuf::Duration& clock_skew, const std::string &prefix, const std::string &inverse_target_frame_id){
  if(robot_state.has_kinematic_state()){
    tf2_msgs::msg::TFMessage tf_msg;
    
    for (const auto& [child_frame_id, transform] :
      robot_state.kinematic_state().transforms_snapshot().child_to_parent_edge_map()) {
      const auto local_time = spot_ros2::applyClockSkew(robot_state.kinematic_state().acquisition_timestamp(), clock_skew);
      if(inverse_target_frame_id == std::string(prefix + child_frame_id)){
        ...
        tf_msg.transforms.push_back(spot_ros2::conversions::toTransformStamped(transform.parent_tform_child(),
          std::string(prefix + transform.parent_frame_name()), 
          std::string(prefix + child_frame_id), 
          local_time));
      }
...
std::optional<geometry_msgs::msg::TwistWithCovarianceStamped> GetOdomTwist(const ::bosdyn::api::RobotState &robot_state, const google::protobuf::Duration& clock_skew){
  if(robot_state.has_kinematic_state()){
    geometry_msgs::msg::TwistWithCovarianceStamped odom_twist_msg;

    odom_twist_msg.header.stamp = spot_ros2::applyClockSkew(robot_state.kinematic_state().acquisition_timestamp(), clock_skew);
...
std::optional<nav_msgs::msg::Odometry> GetOdom(const ::bosdyn::api::RobotState &robot_state, const google::protobuf::Duration& clock_skew, const std::string &prefix, bool is_using_vision){
  if(robot_state.has_kinematic_state()){
    ...
    odom_msg.header.stamp = spot_ros2::applyClockSkew(robot_state.kinematic_state().acquisition_timestamp(), clock_skew);
    if(is_using_vision){
...
std::optional<spot_msgs::msg::PowerState> GetPowerState(const ::bosdyn::api::RobotState &robot_state, const google::protobuf::Duration& clock_skew){
  if(robot_state.has_power_state()){
    ...
    power_state.locomotion_estimated_runtime = builtin_interfaces::build<builtin_interfaces::msg::Duration>()
...
std::optional<spot_msgs::msg::SystemFaultState> GetSystemFaultState(const ::bosdyn::api::RobotState &robot_state, const google::protobuf::Duration& clock_skew){
  if(robot_state.has_system_fault_state()){
    ...
    const auto create_fault_message = [&clock_skew](const ::bosdyn::api::SystemFault &fault){
      ...
      fault_msg.duration = builtin_interfaces::build<builtin_interfaces::msg::Duration>()
                            .sec(fault.duration().seconds()).nanosec(fault.duration().nanos());
...
std::optional<bosdyn_msgs::msg::ManipulatorState> GetManipulatorState(const ::bosdyn::api::RobotState &robot_state){
  if(robot_state.has_manipulator_state()){
    ...
    manipulator_state.estimated_end_effector_force_in_hand.x = robot_state.manipulator_state().estimated_end_effector_force_in_hand().x();
    manipulator_state.estimated_end_effector_force_in_hand.y = robot_state.manipulator_state().estimated_end_effector_force_in_hand().y();
    manipulator_state.estimated_end_effector_force_in_hand.z = robot_state.manipulator_state().estimated_end_effector_force_in_hand().z(); 
    manipulator_state.estimated_end_effector_force_in_hand_is_set = robot_state.manipulator_state().has_estimated_end_effector_force_in_hand();

    manipulator_state.stow_state.value = robot_state.manipulator_state().stow_state();

    manipulator_state.velocity_of_hand_in_vision.linear.x = robot_state.manipulator_state().velocity_of_hand_in_vision().linear().x();
    manipulator_state.velocity_of_hand_in_vision.linear.y = robot_state.manipulator_state().velocity_of_hand_in_vision().linear().y();
    manipulator_state.velocity_of_hand_in_vision.linear.z = robot_state.manipulator_state().velocity_of_hand_in_vision().linear().z();
    manipulator_state.velocity_of_hand_in_vision.angular.x = robot_state.manipulator_state().velocity_of_hand_in_vision().angular().x();
    manipulator_state.velocity_of_hand_in_vision.angular.y = robot_state.manipulator_state().velocity_of_hand_in_vision().angular().y();
    manipulator_state.velocity_of_hand_in_vision.angular.z = robot_state.manipulator_state().velocity_of_hand_in_vision().angular().z();
    manipulator_state.velocity_of_hand_in_vision_is_set = robot_state.manipulator_state().has_velocity_of_hand_in_vision();

    manipulator_state.velocity_of_hand_in_odom.linear.x = robot_state.manipulator_state().velocity_of_hand_in_odom().linear().x();
    manipulator_state.velocity_of_hand_in_odom.linear.y = robot_state.manipulator_state().velocity_of_hand_in_odom().linear().y();
    manipulator_state.velocity_of_hand_in_odom.linear.z = robot_state.manipulator_state().velocity_of_hand_in_odom().linear().z();
    manipulator_state.velocity_of_hand_in_odom.angular.x = robot_state.manipulator_state().velocity_of_hand_in_odom().angular().x();
    manipulator_state.velocity_of_hand_in_odom.angular.y = robot_state.manipulator_state().velocity_of_hand_in_odom().angular().y();
    manipulator_state.velocity_of_hand_in_odom.angular.z = robot_state.manipulator_state().velocity_of_hand_in_odom().angular().z();
...
std::optional<geometry_msgs::msg::Vector3Stamped> GetEndEffectorForce(const ::bosdyn::api::RobotState &robot_state, const google::protobuf::Duration& clock_skew, const std::string &prefix){
  if(robot_state.has_manipulator_state()){
...
std::optional<spot_msgs::msg::BehaviorFaultState> GetBehaviorFaultState(const ::bosdyn::api::RobotState &robot_state, const google::protobuf::Duration& clock_skew){
...
tl::expected<RobotState, std::string> DefaultRobotStateClient::getRobotState() {
  ...
  const auto out = RobotState{
    ...
    GetJointStates(robot_state, clock_skew_result.value(), "Opal/"), //TODO: This should be a parameter passed into the client
    GetTf(robot_state, clock_skew_result.value(), "Opal/", "body"), //TODO: This should be a parameter passed into the client
    GetOdomTwist(robot_state, clock_skew_result.value()),
    GetOdom(robot_state, clock_skew_result.value(),"Opal/", true), //TODO: This should be a parameter passed into the client
