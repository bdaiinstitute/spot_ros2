...
/**
 * @brief Get a rclcpp parameter. If the parameter has not been declared, declare it with the provided default value and then return the value.
 * 
...
/**
 * @brief Attempt to get a value from an environment variable, and if this fails get the value from a rclcpp parameter instead.
 * 
 ...
 * @return If the environment variable was set, return its value. Otherwise, if the rclcpp parameter was set, return its value. If neither the environment variable nor the rclcpp parameter was set. return the default value.
 */
std::string getEnvironmentVariableParameterFallback(const std::shared_ptr<rclcpp::Node>& node,const std::string& env_var_name, const std::string& parameter_name, const std::string& default_value)
{
