...
void convertBosdynMsgsInverseKinematicsRequestFixedStanceToProto(
  ...
  if (ros_msg.fl_rt_scene_is_set) {
    common_conversions::convertGeometryMsgsVector3ToProto(ros_msg.fl_rt_scene, *proto.mutable_fl_rt_scene());
  }
  if (ros_msg.fr_rt_scene_is_set) {
    common_conversions::convertGeometryMsgsVector3ToProto(ros_msg.fr_rt_scene, *proto.mutable_fr_rt_scene());
  }
  if (ros_msg.hl_rt_scene_is_set) {
    common_conversions::convertGeometryMsgsVector3ToProto(ros_msg.hl_rt_scene, *proto.mutable_hl_rt_scene());
  }
  if (ros_msg.hr_rt_scene_is_set) {
    common_conversions::convertGeometryMsgsVector3ToProto(ros_msg.hr_rt_scene, *proto.mutable_hr_rt_scene());
  }
}
...
void convertBosdynMsgsInverseKinematicsRequestBodyMountedToolToProto(
  ...
  if (ros_msg.body_tform_tool_is_set) {
    common_conversions::convertGeometryMsgsPoseToProto(ros_msg.body_tform_tool, *proto.mutable_body_tform_tool());
  }
}
...
void convertBosdynMsgsInverseKinematicsRequestToolGazeTaskToProto(
  ...
  if (ros_msg.target_in_task_is_set) {
    common_conversions::convertGeometryMsgsVector3ToProto(ros_msg.target_in_task, *proto.mutable_target_in_task());
  }
  if (ros_msg.task_tform_desired_tool_is_set) {
    common_conversions::convertGeometryMsgsPoseToProto(ros_msg.task_tform_desired_tool,
                                                            *proto.mutable_task_tform_desired_tool());
...
void convertProtoToBosdynMsgsFrameTreeSnapshot(const bosdyn::api::FrameTreeSnapshot& proto,
  ...
  for (const auto& item : proto.child_to_parent_edge_map()) {
    ...
    edge.key = item.first;
    convertProtoToBosdynMsgsFrameTreeSnapshotParentEdge(item.second, edge.value);
...
void convertProtoToBosdynMsgsInverseKinematicsResponse(const bosdyn::api::spot::InverseKinematicsResponse& proto,
  ...
  convertProtoToBosdynMsgsKinematicState(proto.robot_configuration(), ros_msg.robot_configuration);
