...
class RclcppMiddlewareInterface : public MiddlewareInterface {
 public:
  explicit RclcppMiddlewareInterface(std::shared_ptr<rclcpp::Node> node)
  ...
  ParameterInterfaceBase* parameter_interface() { return parameter_interface_.get(); }
  LoggerInterfaceBase* logger_interface() { return logger_interface_.get(); }
  PublisherInterfaceBase* publisher_interface() { return publisher_interface_.get(); }
  TfInterfaceBase* tf_interface() { return tf_interface_.get(); }
  TimerInterfaceBase* timer_interface() { return timer_interface_.get(); }
