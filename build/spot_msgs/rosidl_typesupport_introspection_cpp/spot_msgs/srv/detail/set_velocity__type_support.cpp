...
{
  new (message_memory) spot_msgs::srv::SetVelocity_Request(_init);
}

void SetVelocity_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<spot_msgs::srv::SetVelocity_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetVelocity_Request_message_member_array[1] = {
  {
    ...
    offsetof(spot_msgs::srv::SetVelocity_Request, velocity_limit),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetVelocity_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(spot_msgs::srv::SetVelocity_Request),
...
{
  return &::spot_msgs::srv::rosidl_typesupport_introspection_cpp::SetVelocity_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, spot_msgs, srv, SetVelocity_Request)() {
  return &::spot_msgs::srv::rosidl_typesupport_introspection_cpp::SetVelocity_Request_message_type_support_handle;
}
...
void SetVelocity_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) spot_msgs::srv::SetVelocity_Response(_init);
}

void SetVelocity_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<spot_msgs::srv::SetVelocity_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetVelocity_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(spot_msgs::srv::SetVelocity_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(spot_msgs::srv::SetVelocity_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetVelocity_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(spot_msgs::srv::SetVelocity_Response),
...
{
  return &::spot_msgs::srv::rosidl_typesupport_introspection_cpp::SetVelocity_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, spot_msgs, srv, SetVelocity_Response)() {
  return &::spot_msgs::srv::rosidl_typesupport_introspection_cpp::SetVelocity_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetVelocity_service_members = {
  ...
  // see get_service_type_support_handle<spot_msgs::srv::SetVelocity>()
...
get_service_type_support_handle<spot_msgs::srv::SetVelocity>()
{
  ...
  auto service_type_support =
    &::spot_msgs::srv::rosidl_typesupport_introspection_cpp::SetVelocity_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::spot_msgs::srv::SetVelocity_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::spot_msgs::srv::SetVelocity_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, spot_msgs, srv, SetVelocity)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<spot_msgs::srv::SetVelocity>();
}
