...
static const _BatteryStateArray_type_support_symbol_names_t _BatteryStateArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_msgs, msg, BatteryStateArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, spot_msgs, msg, BatteryStateArray)),
  }
};
...
{
  return &::spot_msgs::msg::rosidl_typesupport_cpp::BatteryStateArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, spot_msgs, msg, BatteryStateArray)() {
  return get_message_type_support_handle<spot_msgs::msg::BatteryStateArray>();
}
