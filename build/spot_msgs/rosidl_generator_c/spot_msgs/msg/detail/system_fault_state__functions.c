...
spot_msgs__msg__SystemFaultState__create()
{
  ...
  spot_msgs__msg__SystemFaultState * msg = (spot_msgs__msg__SystemFaultState *)allocator.allocate(sizeof(spot_msgs__msg__SystemFaultState), allocator.state);
  if (!msg) {
    return NULL;
  }
...
spot_msgs__msg__SystemFaultState__Sequence__init(spot_msgs__msg__SystemFaultState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__msg__SystemFaultState *)allocator.zero_allocate(size, sizeof(spot_msgs__msg__SystemFaultState), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__msg__SystemFaultState__Sequence * array = (spot_msgs__msg__SystemFaultState__Sequence *)allocator.allocate(sizeof(spot_msgs__msg__SystemFaultState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__msg__SystemFaultState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__msg__SystemFaultState * data =
      (spot_msgs__msg__SystemFaultState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__msg__SystemFaultState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__msg__SystemFaultState__fini(&output->data[i]);
        }
        return false;
      }
    }
