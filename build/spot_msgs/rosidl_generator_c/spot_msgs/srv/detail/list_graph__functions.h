...
#ifndef SPOT_MSGS__SRV__DETAIL__LIST_GRAPH__FUNCTIONS_H_
#define SPOT_MSGS__SRV__DETAIL__LIST_GRAPH__FUNCTIONS_H_
...
/// Initialize srv/ListGraph message.
/**
...
/// Finalize srv/ListGraph message.
/**
...
/// Create srv/ListGraph message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * spot_msgs__srv__ListGraph_Request__init().
...
/// Destroy srv/ListGraph message.
/**
 * It calls
 * spot_msgs__srv__ListGraph_Request__fini()
...
/// Check for srv/ListGraph message equality.
/**
...
/// Initialize array of srv/ListGraph messages.
/**
...
/// Finalize array of srv/ListGraph messages.
/**
 * It calls
 * spot_msgs__srv__ListGraph_Request__fini()
...
/// Create array of srv/ListGraph messages.
/**
 * It allocates the memory for the array and calls
 * spot_msgs__srv__ListGraph_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ListGraph messages.
/**
 * It calls
 * spot_msgs__srv__ListGraph_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ListGraph message array equality.
/**
...
/// Copy an array of srv/ListGraph messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * spot_msgs__srv__ListGraph_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_spot_msgs
...
/**
 * It calls
 * spot_msgs__srv__ListGraph_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_spot_msgs
...
/**
 * It allocates the memory for the array and calls
 * spot_msgs__srv__ListGraph_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_spot_msgs
...
/**
 * It calls
 * spot_msgs__srv__ListGraph_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SPOT_MSGS__SRV__DETAIL__LIST_GRAPH__FUNCTIONS_H_
