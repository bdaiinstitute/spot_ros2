...
spot_msgs__srv__SetLocomotion_Request__create()
{
  ...
  spot_msgs__srv__SetLocomotion_Request * msg = (spot_msgs__srv__SetLocomotion_Request *)allocator.allocate(sizeof(spot_msgs__srv__SetLocomotion_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
spot_msgs__srv__SetLocomotion_Request__Sequence__init(spot_msgs__srv__SetLocomotion_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__srv__SetLocomotion_Request *)allocator.zero_allocate(size, sizeof(spot_msgs__srv__SetLocomotion_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__srv__SetLocomotion_Request__Sequence * array = (spot_msgs__srv__SetLocomotion_Request__Sequence *)allocator.allocate(sizeof(spot_msgs__srv__SetLocomotion_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__srv__SetLocomotion_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__srv__SetLocomotion_Request * data =
      (spot_msgs__srv__SetLocomotion_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__srv__SetLocomotion_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__srv__SetLocomotion_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__srv__SetLocomotion_Response * msg = (spot_msgs__srv__SetLocomotion_Response *)allocator.allocate(sizeof(spot_msgs__srv__SetLocomotion_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
spot_msgs__srv__SetLocomotion_Response__Sequence__init(spot_msgs__srv__SetLocomotion_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__srv__SetLocomotion_Response *)allocator.zero_allocate(size, sizeof(spot_msgs__srv__SetLocomotion_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__srv__SetLocomotion_Response__Sequence * array = (spot_msgs__srv__SetLocomotion_Response__Sequence *)allocator.allocate(sizeof(spot_msgs__srv__SetLocomotion_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__srv__SetLocomotion_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__srv__SetLocomotion_Response * data =
      (spot_msgs__srv__SetLocomotion_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__srv__SetLocomotion_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__srv__SetLocomotion_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
