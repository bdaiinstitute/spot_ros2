...
inline void to_flow_style_yaml(
  const SetLocomotion_Request & msg,
  std::ostream & out)
{
  out << "{";
...
inline std::string to_yaml(const SetLocomotion_Request & msg, bool use_flow_style = false)
{
...
inline void to_flow_style_yaml(
  const SetLocomotion_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: success
...
inline std::string to_yaml(const SetLocomotion_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
