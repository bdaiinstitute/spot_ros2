...
class PlaySound_Request(metaclass=Metaclass_PlaySound_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.volume_multiplier = kwargs.get('volume_multiplier', float())
    ...
    def __eq__(self, other):
        ...
        if self.name != other.name:
            return False
        if self.volume_multiplier != other.volume_multiplier:
            return False
        return True
    ...
    def volume_multiplier(self):
        """Message field 'volume_multiplier'."""
    ...
    def volume_multiplier(self, value):
        if __debug__:
            assert \
                ...
                "The 'volume_multiplier' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'volume_multiplier' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._volume_multiplier = value
...
class Metaclass_PlaySound(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from spot_msgs.srv import _play_sound
...
class PlaySound(metaclass=Metaclass_PlaySound):
    from spot_msgs.srv._play_sound import PlaySound_Request as Request
    from spot_msgs.srv._play_sound import PlaySound_Response as Response
