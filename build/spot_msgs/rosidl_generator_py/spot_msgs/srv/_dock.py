    ...
    def dock_id(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'dock_id' field must be an integer in [-32768, 32767]"
        self._dock_id = value
...
class Metaclass_Dock(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from spot_msgs.srv import _dock
...
class Dock(metaclass=Metaclass_Dock):
    from spot_msgs.srv._dock import Dock_Request as Request
    from spot_msgs.srv._dock import Dock_Response as Response
