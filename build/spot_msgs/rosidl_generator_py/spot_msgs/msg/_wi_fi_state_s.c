...
bool spot_msgs__msg__wi_fi_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("spot_msgs.msg._wi_fi_state.WiFiState", full_classname_dest, 36) == 0);
  }
  spot_msgs__msg__WiFiState * ros_message = _ros_message;
  {  // current_mode
...
PyObject * spot_msgs__msg__wi_fi_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("spot_msgs.msg._wi_fi_state");
