...
bool spot_msgs__msg__battery_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("spot_msgs.msg._battery_state.BatteryState", full_classname_dest, 41) == 0);
  }
  spot_msgs__msg__BatteryState * ros_message = _ros_message;
  {  // header
  ...
  {  // estimated_runtime
    PyObject * field = PyObject_GetAttrString(_pymsg, "estimated_runtime");
    if (!field) {
      return false;
    }
    if (!builtin_interfaces__msg__duration__convert_from_py(field, &ros_message->estimated_runtime)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * spot_msgs__msg__battery_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("spot_msgs.msg._battery_state");
  ...
  {  // estimated_runtime
    PyObject * field = NULL;
    field = builtin_interfaces__msg__duration__convert_to_py(&ros_message->estimated_runtime);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "estimated_runtime", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
