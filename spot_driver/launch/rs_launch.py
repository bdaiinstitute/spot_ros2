...
def declare_configurable_parameters(parameters: List[Dict[str, str]]) -> List[DeclareLaunchArgument]:
    return [
...
def set_configurable_parameters(parameters: List[Dict[str, str]]) -> Dict[str, LaunchConfiguration]:
