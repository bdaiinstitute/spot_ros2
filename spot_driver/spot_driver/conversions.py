...
def convert_bosdyn_msgs_world_object_to_proto(ros_msg, proto):
    ...
    if ros_msg.bounding_box_properties_is_set:
        convert_bosdyn_msgs_bounding_box_properties_to_proto(
...
def convert_proto_to_bosdyn_msgs_network_compute_input_data_one_of_input(proto, ros_msg):
    if proto.HasField("image_source_and_service"):
        ...
        convert_proto_to_bosdyn_msgs_image_source_and_service(
            proto.image_source_and_service, ros_msg.image_source_and_service
        )
...
def convert_bosdyn_msgs_network_compute_input_data_one_of_input_to_proto(ros_msg, proto):
    ...
    if ros_msg.input_choice == ros_msg.INPUT_IMAGE_SOURCE_AND_SERVICE_SET:
        convert_bosdyn_msgs_image_source_and_service_to_proto(
            ros_msg.image_source_and_service, proto.image_source_and_service
        )
...
def convert_proto_to_bosdyn_msgs_frame_tree_snapshot(proto, ros_msg):
    ...
    for _item in proto.child_to_parent_edge_map:
        ...
        convert_proto_to_bosdyn_msgs_frame_tree_snapshot_parent_edge(
            proto.child_to_parent_edge_map[_item], ros_msg.child_to_parent_edge_map[-1].value
        )
...
def convert_bosdyn_msgs_frame_tree_snapshot_to_proto(ros_msg, proto):
    ...
    for _item in ros_msg.child_to_parent_edge_map:
        convert_bosdyn_msgs_frame_tree_snapshot_parent_edge_to_proto(
            _item.value, proto.child_to_parent_edge_map[_item.key]
        )
...
def convert_proto_to_bosdyn_msgs_mobility_command_request_one_of_command(proto, ros_msg):
    if proto.HasField("se2_trajectory_request"):
        ...
        convert_proto_to_bosdyn_msgs_se2_trajectory_command_request(
            proto.se2_trajectory_request, ros_msg.se2_trajectory_request
        )
    if proto.HasField("se2_velocity_request"):
        ros_msg.command_choice = ros_msg.COMMAND_SE2_VELOCITY_REQUEST_SET
        convert_proto_to_bosdyn_msgs_se2_velocity_command_request(
            proto.se2_velocity_request, ros_msg.se2_velocity_request
        )
...
def convert_bosdyn_msgs_mobility_command_request_one_of_command_to_proto(ros_msg, proto):
    ...
    if ros_msg.command_choice == ros_msg.COMMAND_SE2_TRAJECTORY_REQUEST_SET:
        convert_bosdyn_msgs_se2_trajectory_command_request_to_proto(
            ros_msg.se2_trajectory_request, proto.se2_trajectory_request
        )
    if ros_msg.command_choice == ros_msg.COMMAND_SE2_VELOCITY_REQUEST_SET:
        convert_bosdyn_msgs_se2_velocity_command_request_to_proto(
            ros_msg.se2_velocity_request, proto.se2_velocity_request
        )
...
def convert_proto_to_bosdyn_msgs_mobility_command_feedback_one_of_feedback(proto, ros_msg):
    if proto.HasField("se2_trajectory_feedback"):
        ...
        convert_proto_to_bosdyn_msgs_se2_trajectory_command_feedback(
            proto.se2_trajectory_feedback, ros_msg.se2_trajectory_feedback
        )
    if proto.HasField("se2_velocity_feedback"):
        ros_msg.feedback_choice = ros_msg.FEEDBACK_SE2_VELOCITY_FEEDBACK_SET
        convert_proto_to_bosdyn_msgs_se2_velocity_command_feedback(
            proto.se2_velocity_feedback, ros_msg.se2_velocity_feedback
        )
...
def convert_bosdyn_msgs_mobility_command_feedback_one_of_feedback_to_proto(ros_msg, proto):
    ...
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_SE2_TRAJECTORY_FEEDBACK_SET:
        convert_bosdyn_msgs_se2_trajectory_command_feedback_to_proto(
            ros_msg.se2_trajectory_feedback, proto.se2_trajectory_feedback
        )
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_SE2_VELOCITY_FEEDBACK_SET:
        convert_bosdyn_msgs_se2_velocity_command_feedback_to_proto(
            ros_msg.se2_velocity_feedback, proto.se2_velocity_feedback
        )
...
def convert_proto_to_bosdyn_msgs_constrained_manipulation_command_request(proto, ros_msg):
    ...
    convert_proto_to_geometry_msgs_wrench(
        proto.init_wrench_direction_in_frame_name, ros_msg.init_wrench_direction_in_frame_name
    )
...
def convert_bosdyn_msgs_constrained_manipulation_command_request_to_proto(ros_msg, proto):
    ...
    if ros_msg.init_wrench_direction_in_frame_name_is_set:
        convert_geometry_msgs_wrench_to_proto(
            ros_msg.init_wrench_direction_in_frame_name, proto.init_wrench_direction_in_frame_name
        )
...
def convert_proto_to_bosdyn_msgs_power_state(proto, ros_msg):
    ...
    convert_proto_to_builtin_interfaces_duration(
        proto.locomotion_estimated_runtime, ros_msg.locomotion_estimated_runtime
    )
...
def convert_bosdyn_msgs_power_state_to_proto(ros_msg, proto):
    ...
    if ros_msg.locomotion_estimated_runtime_is_set:
        convert_builtin_interfaces_duration_to_proto(
            ros_msg.locomotion_estimated_runtime, proto.locomotion_estimated_runtime
        )
...
def convert_bosdyn_msgs_foot_state_terrain_state_to_proto(ros_msg, proto):
    ...
    if ros_msg.ground_contact_normal_rt_frame_is_set:
        convert_geometry_msgs_vector3_to_proto(
            ros_msg.ground_contact_normal_rt_frame, proto.ground_contact_normal_rt_frame
        )
...
def convert_proto_to_bosdyn_msgs_manipulator_state(proto, ros_msg):
    ...
    convert_proto_to_geometry_msgs_vector3(
        proto.estimated_end_effector_force_in_hand, ros_msg.estimated_end_effector_force_in_hand
    )
...
def convert_bosdyn_msgs_manipulator_state_to_proto(ros_msg, proto):
    ...
    if ros_msg.estimated_end_effector_force_in_hand_is_set:
        convert_geometry_msgs_vector3_to_proto(
            ros_msg.estimated_end_effector_force_in_hand, proto.estimated_end_effector_force_in_hand
        )
...
def convert_bosdyn_msgs_robot_hardware_configuration_response_to_proto(ros_msg, proto):
    ...
    if ros_msg.hardware_configuration_is_set:
        convert_bosdyn_msgs_hardware_configuration_to_proto(
            ros_msg.hardware_configuration, proto.hardware_configuration
        )
...
def convert_bosdyn_msgs_point_cloud_to_proto(ros_msg, proto):
    ...
    if ros_msg.encoding_parameters_is_set:
        convert_bosdyn_msgs_point_cloud_encoding_parameters_to_proto(
            ros_msg.encoding_parameters, proto.encoding_parameters
        )
    proto.data = ros_msg.data
...
def convert_proto_to_bosdyn_msgs_allowable_orientation_one_of_constraint(proto, ros_msg):
    if proto.HasField("rotation_with_tolerance"):
        ...
        convert_proto_to_bosdyn_msgs_rotation_with_tolerance(
            proto.rotation_with_tolerance, ros_msg.rotation_with_tolerance
        )
    if proto.HasField("vector_alignment_with_tolerance"):
        ...
        convert_proto_to_bosdyn_msgs_vector_alignment_with_tolerance(
            proto.vector_alignment_with_tolerance, ros_msg.vector_alignment_with_tolerance
        )
...
def convert_bosdyn_msgs_allowable_orientation_one_of_constraint_to_proto(ros_msg, proto):
    ...
    if ros_msg.constraint_choice == ros_msg.CONSTRAINT_ROTATION_WITH_TOLERANCE_SET:
        convert_bosdyn_msgs_rotation_with_tolerance_to_proto(
            ros_msg.rotation_with_tolerance, proto.rotation_with_tolerance
        )
    if ros_msg.constraint_choice == ros_msg.CONSTRAINT_VECTOR_ALIGNMENT_WITH_TOLERANCE_SET:
        convert_bosdyn_msgs_vector_alignment_with_tolerance_to_proto(
            ros_msg.vector_alignment_with_tolerance, proto.vector_alignment_with_tolerance
        )
...
def convert_bosdyn_msgs_vector_alignment_with_tolerance_to_proto(ros_msg, proto):
    ...
    if ros_msg.axis_to_align_with_ewrt_frame_is_set:
        convert_geometry_msgs_vector3_to_proto(
            ros_msg.axis_to_align_with_ewrt_frame, proto.axis_to_align_with_ewrt_frame
        )
    proto.threshold_radians = ros_msg.threshold_radians
...
def convert_proto_to_bosdyn_msgs_manipulation_api_request_one_of_manipulation_cmd(proto, ros_msg):
    if proto.HasField("walk_to_object_ray_in_world"):
        ...
        convert_proto_to_bosdyn_msgs_walk_to_object_ray_in_world(
            proto.walk_to_object_ray_in_world, ros_msg.walk_to_object_ray_in_world
        )
    if proto.HasField("walk_to_object_in_image"):
        ...
        convert_proto_to_bosdyn_msgs_walk_to_object_in_image(
            proto.walk_to_object_in_image, ros_msg.walk_to_object_in_image
        )
    ...
    if proto.HasField("pick_object_ray_in_world"):
        ...
        convert_proto_to_bosdyn_msgs_pick_object_ray_in_world(
            proto.pick_object_ray_in_world, ros_msg.pick_object_ray_in_world
        )
    if proto.HasField("pick_object_execute_plan"):
        ...
        convert_proto_to_bosdyn_msgs_pick_object_execute_plan(
            proto.pick_object_execute_plan, ros_msg.pick_object_execute_plan
        )
...
def convert_bosdyn_msgs_manipulation_api_request_one_of_manipulation_cmd_to_proto(ros_msg, proto):
    ...
    if ros_msg.manipulation_cmd_choice == ros_msg.MANIPULATION_CMD_WALK_TO_OBJECT_RAY_IN_WORLD_SET:
        convert_bosdyn_msgs_walk_to_object_ray_in_world_to_proto(
            ros_msg.walk_to_object_ray_in_world, proto.walk_to_object_ray_in_world
        )
    if ros_msg.manipulation_cmd_choice == ros_msg.MANIPULATION_CMD_WALK_TO_OBJECT_IN_IMAGE_SET:
        convert_bosdyn_msgs_walk_to_object_in_image_to_proto(
            ros_msg.walk_to_object_in_image, proto.walk_to_object_in_image
        )
    ...
    if ros_msg.manipulation_cmd_choice == ros_msg.MANIPULATION_CMD_PICK_OBJECT_RAY_IN_WORLD_SET:
        convert_bosdyn_msgs_pick_object_ray_in_world_to_proto(
            ros_msg.pick_object_ray_in_world, proto.pick_object_ray_in_world
        )
    if ros_msg.manipulation_cmd_choice == ros_msg.MANIPULATION_CMD_PICK_OBJECT_EXECUTE_PLAN_SET:
        convert_bosdyn_msgs_pick_object_execute_plan_to_proto(
...
def convert_proto_to_bosdyn_msgs_api_grasp_override_request(proto, ros_msg):
    ...
    convert_proto_to_bosdyn_msgs_api_grasped_carry_state_override(
        proto.carry_state_override, ros_msg.carry_state_override
    )
...
def convert_bosdyn_msgs_api_grasp_override_request_to_proto(ros_msg, proto):
    ...
    if ros_msg.carry_state_override_is_set:
        convert_bosdyn_msgs_api_grasped_carry_state_override_to_proto(
            ros_msg.carry_state_override, proto.carry_state_override
        )
...
def convert_proto_to_bosdyn_msgs_payload(proto, ros_msg):
    ...
    convert_proto_to_bosdyn_msgs_payload_mass_volume_properties(
        proto.mass_volume_properties, ros_msg.mass_volume_properties
    )
...
def convert_bosdyn_msgs_payload_to_proto(ros_msg, proto):
    ...
    if ros_msg.mass_volume_properties_is_set:
        convert_bosdyn_msgs_payload_mass_volume_properties_to_proto(
            ros_msg.mass_volume_properties, proto.mass_volume_properties
        )
...
def convert_proto_to_bosdyn_msgs_robot_command_one_of_command(proto, ros_msg):
    ...
    if proto.HasField("synchronized_command"):
        ...
        convert_proto_to_bosdyn_msgs_synchronized_command_request(
            proto.synchronized_command, ros_msg.synchronized_command
        )
...
def convert_bosdyn_msgs_robot_command_one_of_command_to_proto(ros_msg, proto):
    ...
    if ros_msg.command_choice == ros_msg.COMMAND_SYNCHRONIZED_COMMAND_SET:
        convert_bosdyn_msgs_synchronized_command_request_to_proto(
            ros_msg.synchronized_command, proto.synchronized_command
        )
...
def convert_proto_to_bosdyn_msgs_robot_command_feedback_one_of_command(proto, ros_msg):
    ...
    if proto.HasField("synchronized_feedback"):
        ...
        convert_proto_to_bosdyn_msgs_synchronized_command_feedback(
            proto.synchronized_feedback, ros_msg.synchronized_feedback
        )
...
def convert_bosdyn_msgs_robot_command_feedback_one_of_command_to_proto(ros_msg, proto):
    ...
    if ros_msg.command_choice == ros_msg.COMMAND_SYNCHRONIZED_FEEDBACK_SET:
        convert_bosdyn_msgs_synchronized_command_feedback_to_proto(
            ros_msg.synchronized_feedback, proto.synchronized_feedback
        )
...
def convert_proto_to_bosdyn_msgs_arm_command_request_one_of_command(proto, ros_msg):
    if proto.HasField("arm_cartesian_command"):
        ...
        convert_proto_to_bosdyn_msgs_arm_cartesian_command_request(
            proto.arm_cartesian_command, ros_msg.arm_cartesian_command
        )
    if proto.HasField("arm_joint_move_command"):
        ros_msg.command_choice = ros_msg.COMMAND_ARM_JOINT_MOVE_COMMAND_SET
        convert_proto_to_bosdyn_msgs_arm_joint_move_command_request(
            proto.arm_joint_move_command, ros_msg.arm_joint_move_command
        )
    if proto.HasField("named_arm_position_command"):
        ros_msg.command_choice = ros_msg.COMMAND_NAMED_ARM_POSITION_COMMAND_SET
        convert_proto_to_bosdyn_msgs_named_arm_positions_command_request(
            proto.named_arm_position_command, ros_msg.named_arm_position_command
        )
    if proto.HasField("arm_velocity_command"):
        ros_msg.command_choice = ros_msg.COMMAND_ARM_VELOCITY_COMMAND_SET
        convert_proto_to_bosdyn_msgs_arm_velocity_command_request(
            proto.arm_velocity_command, ros_msg.arm_velocity_command
        )
    ...
    if proto.HasField("arm_impedance_command"):
        ...
        convert_proto_to_bosdyn_msgs_arm_impedance_command_request(
            proto.arm_impedance_command, ros_msg.arm_impedance_command
        )
...
def convert_bosdyn_msgs_arm_command_request_one_of_command_to_proto(ros_msg, proto):
    ...
    if ros_msg.command_choice == ros_msg.COMMAND_ARM_CARTESIAN_COMMAND_SET:
        convert_bosdyn_msgs_arm_cartesian_command_request_to_proto(
            ros_msg.arm_cartesian_command, proto.arm_cartesian_command
        )
    if ros_msg.command_choice == ros_msg.COMMAND_ARM_JOINT_MOVE_COMMAND_SET:
        convert_bosdyn_msgs_arm_joint_move_command_request_to_proto(
            ros_msg.arm_joint_move_command, proto.arm_joint_move_command
        )
    if ros_msg.command_choice == ros_msg.COMMAND_NAMED_ARM_POSITION_COMMAND_SET:
        convert_bosdyn_msgs_named_arm_positions_command_request_to_proto(
            ros_msg.named_arm_position_command, proto.named_arm_position_command
        )
    if ros_msg.command_choice == ros_msg.COMMAND_ARM_VELOCITY_COMMAND_SET:
        convert_bosdyn_msgs_arm_velocity_command_request_to_proto(
            ros_msg.arm_velocity_command, proto.arm_velocity_command
        )
    ...
    if ros_msg.command_choice == ros_msg.COMMAND_ARM_IMPEDANCE_COMMAND_SET:
        convert_bosdyn_msgs_arm_impedance_command_request_to_proto(
            ros_msg.arm_impedance_command, proto.arm_impedance_command
        )
...
def convert_proto_to_bosdyn_msgs_arm_command_feedback_one_of_feedback(proto, ros_msg):
    if proto.HasField("arm_cartesian_feedback"):
        ...
        convert_proto_to_bosdyn_msgs_arm_cartesian_command_feedback(
            proto.arm_cartesian_feedback, ros_msg.arm_cartesian_feedback
        )
    if proto.HasField("arm_joint_move_feedback"):
        ros_msg.feedback_choice = ros_msg.FEEDBACK_ARM_JOINT_MOVE_FEEDBACK_SET
        convert_proto_to_bosdyn_msgs_arm_joint_move_command_feedback(
    ...
    if proto.HasField("named_arm_position_feedback"):
        ...
        convert_proto_to_bosdyn_msgs_named_arm_positions_command_feedback(
            proto.named_arm_position_feedback, ros_msg.named_arm_position_feedback
        )
    if proto.HasField("arm_velocity_feedback"):
        ...
        convert_proto_to_bosdyn_msgs_arm_velocity_command_feedback(
            proto.arm_velocity_feedback, ros_msg.arm_velocity_feedback
        )
    ...
    if proto.HasField("arm_impedance_feedback"):
        ...
        convert_proto_to_bosdyn_msgs_arm_impedance_command_feedback(
            proto.arm_impedance_feedback, ros_msg.arm_impedance_feedback
        )
...
def convert_bosdyn_msgs_arm_command_feedback_one_of_feedback_to_proto(ros_msg, proto):
    ...
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_ARM_CARTESIAN_FEEDBACK_SET:
        convert_bosdyn_msgs_arm_cartesian_command_feedback_to_proto(
    ...
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_ARM_JOINT_MOVE_FEEDBACK_SET:
        convert_bosdyn_msgs_arm_joint_move_command_feedback_to_proto(
            ros_msg.arm_joint_move_feedback, proto.arm_joint_move_feedback
        )
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_NAMED_ARM_POSITION_FEEDBACK_SET:
        convert_bosdyn_msgs_named_arm_positions_command_feedback_to_proto(
            ros_msg.named_arm_position_feedback, proto.named_arm_position_feedback
        )
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_ARM_VELOCITY_FEEDBACK_SET:
        convert_bosdyn_msgs_arm_velocity_command_feedback_to_proto(
            ros_msg.arm_velocity_feedback, proto.arm_velocity_feedback
        )
    ...
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_ARM_IMPEDANCE_FEEDBACK_SET:
        convert_bosdyn_msgs_arm_impedance_command_feedback_to_proto(
            ros_msg.arm_impedance_feedback, proto.arm_impedance_feedback
        )
...
def convert_proto_to_bosdyn_msgs_arm_velocity_command_request_one_of_command(proto, ros_msg):
    if proto.HasField("cylindrical_velocity"):
        ...
        convert_proto_to_bosdyn_msgs_arm_velocity_command_cylindrical_velocity(
            proto.cylindrical_velocity, ros_msg.cylindrical_velocity
        )
    if proto.HasField("cartesian_velocity"):
        ...
        convert_proto_to_bosdyn_msgs_arm_velocity_command_cartesian_velocity(
            proto.cartesian_velocity, ros_msg.cartesian_velocity
        )
...
def convert_bosdyn_msgs_arm_velocity_command_request_one_of_command_to_proto(ros_msg, proto):
    ...
    if ros_msg.command_choice == ros_msg.COMMAND_CYLINDRICAL_VELOCITY_SET:
        convert_bosdyn_msgs_arm_velocity_command_cylindrical_velocity_to_proto(
            ros_msg.cylindrical_velocity, proto.cylindrical_velocity
        )
    if ros_msg.command_choice == ros_msg.COMMAND_CARTESIAN_VELOCITY_SET:
        convert_bosdyn_msgs_arm_velocity_command_cartesian_velocity_to_proto(
            ros_msg.cartesian_velocity, proto.cartesian_velocity
        )
...
def convert_proto_to_bosdyn_msgs_arm_velocity_command_request(proto, ros_msg):
    ...
    convert_proto_to_geometry_msgs_vector3(
        proto.angular_velocity_of_hand_rt_odom_in_hand, ros_msg.angular_velocity_of_hand_rt_odom_in_hand
    )
...
def convert_bosdyn_msgs_arm_velocity_command_request_to_proto(ros_msg, proto):
    ...
    if ros_msg.angular_velocity_of_hand_rt_odom_in_hand_is_set:
        convert_geometry_msgs_vector3_to_proto(
            ros_msg.angular_velocity_of_hand_rt_odom_in_hand, proto.angular_velocity_of_hand_rt_odom_in_hand
        )
...
def convert_proto_to_bosdyn_msgs_arm_cartesian_command_request_one_of_joint_configuration(proto, ros_msg):
    if proto.HasField("force_remain_near_current_joint_configuration"):
        ros_msg.joint_configuration_choice = (
            ros_msg.JOINT_CONFIGURATION_FORCE_REMAIN_NEAR_CURRENT_JOINT_CONFIGURATION_SET
        )
    ...
    if proto.HasField("preferred_joint_configuration"):
        ...
        convert_proto_to_bosdyn_msgs_arm_joint_position(
            proto.preferred_joint_configuration, ros_msg.preferred_joint_configuration
        )
...
def convert_bosdyn_msgs_arm_cartesian_command_request_one_of_joint_configuration_to_proto(ros_msg, proto):
    ...
    if ros_msg.joint_configuration_choice == ros_msg.JOINT_CONFIGURATION_PREFERRED_JOINT_CONFIGURATION_SET:
        convert_bosdyn_msgs_arm_joint_position_to_proto(
            ros_msg.preferred_joint_configuration, proto.preferred_joint_configuration
        )
...
def convert_proto_to_bosdyn_msgs_arm_cartesian_command_request(proto, ros_msg):
    ...
    convert_proto_to_bosdyn_msgs_arm_cartesian_command_request_one_of_joint_configuration(
        proto, ros_msg.joint_configuration
    )
...
def convert_bosdyn_msgs_arm_cartesian_command_request_to_proto(ros_msg, proto):
    ...
    convert_bosdyn_msgs_arm_cartesian_command_request_one_of_joint_configuration_to_proto(
        ros_msg.joint_configuration, proto
    )
    ...
    if ros_msg.wrench_trajectory_in_task_is_set:
        convert_bosdyn_msgs_wrench_trajectory_to_proto(
            ros_msg.wrench_trajectory_in_task, proto.wrench_trajectory_in_task
        )
...
def convert_bosdyn_msgs_gaze_command_request_to_proto(ros_msg, proto):
    ...
    if ros_msg.target_trajectory_in_frame1_is_set:
        convert_bosdyn_msgs_vec3_trajectory_to_proto(
            ros_msg.target_trajectory_in_frame1, proto.target_trajectory_in_frame1
        )
...
def convert_proto_to_bosdyn_msgs_arm_impedance_command_request(proto, ros_msg):
    ...
    ros_msg.feed_forward_wrench_at_tool_in_desired_tool_is_set = proto.HasField(
...
def convert_bosdyn_msgs_arm_impedance_command_request_to_proto(ros_msg, proto):
    ...
    if ros_msg.feed_forward_wrench_at_tool_in_desired_tool_is_set:
        convert_geometry_msgs_wrench_to_proto(
            ros_msg.feed_forward_wrench_at_tool_in_desired_tool, proto.feed_forward_wrench_at_tool_in_desired_tool
        )
...
def convert_proto_to_bosdyn_msgs_gripper_command_request_one_of_command(proto, ros_msg):
    if proto.HasField("claw_gripper_command"):
        ...
        convert_proto_to_bosdyn_msgs_claw_gripper_command_request(
            proto.claw_gripper_command, ros_msg.claw_gripper_command
        )
...
def convert_bosdyn_msgs_gripper_command_request_one_of_command_to_proto(ros_msg, proto):
    ...
    if ros_msg.command_choice == ros_msg.COMMAND_CLAW_GRIPPER_COMMAND_SET:
        convert_bosdyn_msgs_claw_gripper_command_request_to_proto(
            ros_msg.claw_gripper_command, proto.claw_gripper_command
        )
...
def convert_proto_to_bosdyn_msgs_gripper_command_feedback_one_of_command(proto, ros_msg):
    if proto.HasField("claw_gripper_feedback"):
        ...
        convert_proto_to_bosdyn_msgs_claw_gripper_command_feedback(
...
def convert_bosdyn_msgs_gripper_command_feedback_one_of_command_to_proto(ros_msg, proto):
    ...
    if ros_msg.command_choice == ros_msg.COMMAND_CLAW_GRIPPER_FEEDBACK_SET:
        convert_bosdyn_msgs_claw_gripper_command_feedback_to_proto(
            ros_msg.claw_gripper_feedback, proto.claw_gripper_feedback
        )
...
def convert_proto_to_bosdyn_msgs_synchronized_command_feedback(proto, ros_msg):
    ...
    convert_proto_to_bosdyn_msgs_mobility_command_feedback(
        proto.mobility_command_feedback, ros_msg.mobility_command_feedback
    )
    ros_msg.mobility_command_feedback_is_set = proto.HasField("mobility_command_feedback")
    convert_proto_to_bosdyn_msgs_gripper_command_feedback(
        proto.gripper_command_feedback, ros_msg.gripper_command_feedback
    )
...
def convert_bosdyn_msgs_synchronized_command_feedback_to_proto(ros_msg, proto):
    ...
    if ros_msg.mobility_command_feedback_is_set:
        convert_bosdyn_msgs_mobility_command_feedback_to_proto(
            ros_msg.mobility_command_feedback, proto.mobility_command_feedback
        )
    if ros_msg.gripper_command_feedback_is_set:
        convert_bosdyn_msgs_gripper_command_feedback_to_proto(
            ros_msg.gripper_command_feedback, proto.gripper_command_feedback
        )
...
def convert_proto_to_bosdyn_msgs_arm_surface_contact_request(proto, ros_msg):
    ...
    ros_msg.max_rot_tracking_error = proto.max_rot_tracking_error.value
    ros_msg.max_rot_tracking_error_is_set = proto.HasField("max_rot_tracking_error")
    convert_proto_to_bosdyn_msgs_arm_surface_contact_request_one_of_joint_configuration(
        proto, ros_msg.joint_configuration
    )
    ros_msg.x_axis.value = proto.x_axis
    ros_msg.y_axis.value = proto.y_axis
...
def convert_bosdyn_msgs_arm_surface_contact_request_to_proto(ros_msg, proto):
    ...
    if ros_msg.max_rot_tracking_error_is_set:
        convert_float64_to_proto(ros_msg.max_rot_tracking_error, proto.max_rot_tracking_error)
    convert_bosdyn_msgs_arm_surface_contact_request_one_of_joint_configuration_to_proto(
        ros_msg.joint_configuration, proto
    )
    proto.x_axis = ros_msg.x_axis.value
    proto.y_axis = ros_msg.y_axis.value
...
def convert_proto_to_bosdyn_msgs_full_body_command_request_one_of_command(proto, ros_msg):
    ...
    if proto.HasField("battery_change_pose_request"):
        ...
        convert_proto_to_bosdyn_msgs_battery_change_pose_command_request(
            proto.battery_change_pose_request, ros_msg.battery_change_pose_request
        )
    if proto.HasField("payload_estimation_request"):
        ros_msg.command_choice = ros_msg.COMMAND_PAYLOAD_ESTIMATION_REQUEST_SET
        convert_proto_to_bosdyn_msgs_payload_estimation_command_request(
            proto.payload_estimation_request, ros_msg.payload_estimation_request
        )
    if proto.HasField("constrained_manipulation_request"):
        ...
        convert_proto_to_bosdyn_msgs_constrained_manipulation_command_request(
            proto.constrained_manipulation_request, ros_msg.constrained_manipulation_request
        )
...
def convert_bosdyn_msgs_full_body_command_request_one_of_command_to_proto(ros_msg, proto):
    ...
    if ros_msg.command_choice == ros_msg.COMMAND_SAFE_POWER_OFF_REQUEST_SET:
        convert_bosdyn_msgs_safe_power_off_command_request_to_proto(
            ros_msg.safe_power_off_request, proto.safe_power_off_request
        )
    if ros_msg.command_choice == ros_msg.COMMAND_BATTERY_CHANGE_POSE_REQUEST_SET:
        convert_bosdyn_msgs_battery_change_pose_command_request_to_proto(
            ros_msg.battery_change_pose_request, proto.battery_change_pose_request
        )
    if ros_msg.command_choice == ros_msg.COMMAND_PAYLOAD_ESTIMATION_REQUEST_SET:
        convert_bosdyn_msgs_payload_estimation_command_request_to_proto(
            ros_msg.payload_estimation_request, proto.payload_estimation_request
        )
    if ros_msg.command_choice == ros_msg.COMMAND_CONSTRAINED_MANIPULATION_REQUEST_SET:
        convert_bosdyn_msgs_constrained_manipulation_command_request_to_proto(
            ros_msg.constrained_manipulation_request, proto.constrained_manipulation_request
        )
...
def convert_proto_to_bosdyn_msgs_full_body_command_feedback_one_of_feedback(proto, ros_msg):
    ...
    if proto.HasField("safe_power_off_feedback"):
        ...
        convert_proto_to_bosdyn_msgs_safe_power_off_command_feedback(
            proto.safe_power_off_feedback, ros_msg.safe_power_off_feedback
        )
    if proto.HasField("battery_change_pose_feedback"):
        ros_msg.feedback_choice = ros_msg.FEEDBACK_BATTERY_CHANGE_POSE_FEEDBACK_SET
        convert_proto_to_bosdyn_msgs_battery_change_pose_command_feedback(
            proto.battery_change_pose_feedback, ros_msg.battery_change_pose_feedback
        )
    if proto.HasField("payload_estimation_feedback"):
        ros_msg.feedback_choice = ros_msg.FEEDBACK_PAYLOAD_ESTIMATION_FEEDBACK_SET
        convert_proto_to_bosdyn_msgs_payload_estimation_command_feedback(
            proto.payload_estimation_feedback, ros_msg.payload_estimation_feedback
        )
    if proto.HasField("constrained_manipulation_feedback"):
        ...
        convert_proto_to_bosdyn_msgs_constrained_manipulation_command_feedback(
            proto.constrained_manipulation_feedback, ros_msg.constrained_manipulation_feedback
        )
...
def convert_bosdyn_msgs_full_body_command_feedback_one_of_feedback_to_proto(ros_msg, proto):
    ...
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_SAFE_POWER_OFF_FEEDBACK_SET:
        convert_bosdyn_msgs_safe_power_off_command_feedback_to_proto(
    ...
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_BATTERY_CHANGE_POSE_FEEDBACK_SET:
        convert_bosdyn_msgs_battery_change_pose_command_feedback_to_proto(
            ros_msg.battery_change_pose_feedback, proto.battery_change_pose_feedback
        )
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_PAYLOAD_ESTIMATION_FEEDBACK_SET:
        convert_bosdyn_msgs_payload_estimation_command_feedback_to_proto(
    ...
    if ros_msg.feedback_choice == ros_msg.FEEDBACK_CONSTRAINED_MANIPULATION_FEEDBACK_SET:
        convert_bosdyn_msgs_constrained_manipulation_command_feedback_to_proto(
            ros_msg.constrained_manipulation_feedback, proto.constrained_manipulation_feedback
        )
...
def convert_proto_to_bosdyn_msgs_waypoint_annotations_localize_region_one_of_region(proto, ros_msg):
    if proto.HasField("default_region"):
        ...
        convert_proto_to_bosdyn_msgs_waypoint_annotations_localize_region_default(
            proto.default_region, ros_msg.default_region
        )
...
def convert_bosdyn_msgs_waypoint_annotations_localize_region_one_of_region_to_proto(ros_msg, proto):
    ...
    if ros_msg.region_choice == ros_msg.REGION_DEFAULT_REGION_SET:
        convert_bosdyn_msgs_waypoint_annotations_localize_region_default_to_proto(
            ros_msg.default_region, proto.default_region
        )
...
def convert_proto_to_bosdyn_msgs_waypoint_annotations(proto, ros_msg):
    ...
    convert_proto_to_bosdyn_msgs_waypoint_annotations_localize_region(
...
def convert_bosdyn_msgs_waypoint_annotations_to_proto(ros_msg, proto):
    ...
    if ros_msg.scan_match_region_is_set:
        convert_bosdyn_msgs_waypoint_annotations_localize_region_to_proto(
            ros_msg.scan_match_region, proto.scan_match_region
        )
...
def convert_proto_to_bosdyn_msgs_waypoint_snapshot(proto, ros_msg):
    ...
    convert_proto_to_geometry_msgs_pose(
        proto.body_tform_remote_point_cloud_sensor, ros_msg.body_tform_remote_point_cloud_sensor
    )
...
def convert_bosdyn_msgs_waypoint_snapshot_to_proto(ros_msg, proto):
    ...
    if ros_msg.body_tform_remote_point_cloud_sensor_is_set:
        convert_geometry_msgs_pose_to_proto(
            ros_msg.body_tform_remote_point_cloud_sensor, proto.body_tform_remote_point_cloud_sensor
        )
    del proto.payloads[:]
    for _item in ros_msg.payloads:
        convert_bosdyn_msgs_payload_to_proto(_item, proto.payloads.add())
...
def convert_proto_to_bosdyn_msgs_process_topology_request_params(proto, ros_msg):
    ...
    convert_proto_to_bosdyn_msgs_process_topology_request_odometry_loop_closure_params(
        proto.odometry_loop_closure_params, ros_msg.odometry_loop_closure_params
    )
    ...
    convert_proto_to_bosdyn_msgs_process_topology_request_fiducial_loop_closure_params(
        proto.fiducial_loop_closure_params, ros_msg.fiducial_loop_closure_params
    )
    ros_msg.fiducial_loop_closure_params_is_set = proto.HasField("fiducial_loop_closure_params")
    convert_proto_to_bosdyn_msgs_process_topology_request_collision_checking_params(
        proto.collision_check_params, ros_msg.collision_check_params
    )
...
def convert_bosdyn_msgs_process_topology_request_params_to_proto(ros_msg, proto):
    ...
    if ros_msg.odometry_loop_closure_params_is_set:
        convert_bosdyn_msgs_process_topology_request_odometry_loop_closure_params_to_proto(
            ros_msg.odometry_loop_closure_params, proto.odometry_loop_closure_params
        )
    ...
    if ros_msg.fiducial_loop_closure_params_is_set:
        convert_bosdyn_msgs_process_topology_request_fiducial_loop_closure_params_to_proto(
            ros_msg.fiducial_loop_closure_params, proto.fiducial_loop_closure_params
        )
    if ros_msg.collision_check_params_is_set:
        convert_bosdyn_msgs_process_topology_request_collision_checking_params_to_proto(
            ros_msg.collision_check_params, proto.collision_check_params
        )
...
def convert_proto_to_bosdyn_msgs_waypoint_anchor_hint(proto, ros_msg):
    ...
    convert_proto_to_bosdyn_msgs_anchor_hint_uncertainty(
        proto.seed_tform_waypoint_uncertainty, ros_msg.seed_tform_waypoint_uncertainty
    )
    ...
    convert_proto_to_bosdyn_msgs_pose_bounds(
        proto.seed_tform_waypoint_constraint, ros_msg.seed_tform_waypoint_constraint
    )
...
def convert_bosdyn_msgs_waypoint_anchor_hint_to_proto(ros_msg, proto):
    ...
    if ros_msg.seed_tform_waypoint_uncertainty_is_set:
        convert_bosdyn_msgs_anchor_hint_uncertainty_to_proto(
            ros_msg.seed_tform_waypoint_uncertainty, proto.seed_tform_waypoint_uncertainty
        )
    if ros_msg.seed_tform_waypoint_constraint_is_set:
        convert_bosdyn_msgs_pose_bounds_to_proto(
            ros_msg.seed_tform_waypoint_constraint, proto.seed_tform_waypoint_constraint
        )
...
def convert_bosdyn_msgs_world_object_anchor_hint_to_proto(ros_msg, proto):
    ...
    if ros_msg.seed_tform_object_uncertainty_is_set:
        convert_bosdyn_msgs_anchor_hint_uncertainty_to_proto(
            ros_msg.seed_tform_object_uncertainty, proto.seed_tform_object_uncertainty
        )
...
def convert_proto_to_bosdyn_msgs_process_anchoring_request_params(proto, ros_msg):
    convert_proto_to_bosdyn_msgs_process_anchoring_request_params_optimizer_params(
        proto.optimizer_params, ros_msg.optimizer_params
    )
    ros_msg.optimizer_params_is_set = proto.HasField("optimizer_params")
    convert_proto_to_bosdyn_msgs_process_anchoring_request_params_measurement_params(
        proto.measurement_params, ros_msg.measurement_params
    )
...
def convert_bosdyn_msgs_process_anchoring_request_params_to_proto(ros_msg, proto):
    ...
    if ros_msg.optimizer_params_is_set:
        convert_bosdyn_msgs_process_anchoring_request_params_optimizer_params_to_proto(
            ros_msg.optimizer_params, proto.optimizer_params
        )
    if ros_msg.measurement_params_is_set:
        convert_bosdyn_msgs_process_anchoring_request_params_measurement_params_to_proto(
...
def convert_proto_to_bosdyn_msgs_set_localization_request_one_of_refinement(proto, ros_msg):
    ...
    if proto.HasField("refine_with_visual_features"):
        ...
        convert_proto_to_bosdyn_msgs_visual_refinement_options(
            proto.refine_with_visual_features, ros_msg.refine_with_visual_features
        )
...
def convert_bosdyn_msgs_set_localization_request_one_of_refinement_to_proto(ros_msg, proto):
    ...
    if ros_msg.refinement_choice == ros_msg.REFINEMENT_REFINE_WITH_VISUAL_FEATURES_SET:
        convert_bosdyn_msgs_visual_refinement_options_to_proto(
            ros_msg.refine_with_visual_features, proto.refine_with_visual_features
        )
...
def convert_bosdyn_msgs_set_localization_response_suspected_ambiguity_to_proto(ros_msg, proto):
    ...
    if ros_msg.alternate_robot_tform_waypoint_is_set:
        convert_geometry_msgs_pose_to_proto(
            ros_msg.alternate_robot_tform_waypoint, proto.alternate_robot_tform_waypoint
        )
...
def convert_proto_to_bosdyn_msgs_set_localization_response(proto, ros_msg):
    ...
    convert_proto_to_bosdyn_msgs_set_localization_response_suspected_ambiguity(
        proto.suspected_ambiguity, ros_msg.suspected_ambiguity
    )
...
def convert_proto_to_bosdyn_msgs_navigate_to_request(proto, ros_msg):
    ...
    ros_msg.end_time_is_set = proto.HasField("end_time")
    ros_msg.clock_identifier = proto.clock_identifier
    convert_proto_to_bosdyn_msgs_se2_pose(
        proto.destination_waypoint_tform_body_goal, ros_msg.destination_waypoint_tform_body_goal
    )
...
def convert_bosdyn_msgs_navigate_to_request_to_proto(ros_msg, proto):
    ...
    if ros_msg.destination_waypoint_tform_body_goal_is_set:
        convert_bosdyn_msgs_se2_pose_to_proto(
            ros_msg.destination_waypoint_tform_body_goal, proto.destination_waypoint_tform_body_goal
        )
    proto.command_id = ros_msg.command_id
...
def convert_proto_to_bosdyn_msgs_navigate_to_anchor_request(proto, ros_msg):
    ...
    convert_proto_to_geometry_msgs_vector3(
        proto.goal_waypoint_rt_seed_ewrt_seed_tolerance, ros_msg.goal_waypoint_rt_seed_ewrt_seed_tolerance
    )
    ros_msg.goal_waypoint_rt_seed_ewrt_seed_tolerance_is_set = proto.HasField(
...
def convert_bosdyn_msgs_navigate_to_anchor_request_to_proto(ros_msg, proto):
    ...
    if ros_msg.goal_waypoint_rt_seed_ewrt_seed_tolerance_is_set:
        convert_geometry_msgs_vector3_to_proto(
            ros_msg.goal_waypoint_rt_seed_ewrt_seed_tolerance, proto.goal_waypoint_rt_seed_ewrt_seed_tolerance
        )
    if ros_msg.route_params_is_set:
        convert_bosdyn_msgs_route_gen_params_to_proto(ros_msg.route_params, proto.route_params)
    if ros_msg.travel_params_is_set:
...
def convert_proto_to_bosdyn_msgs_navigation_feedback_response(proto, ros_msg):
    ...
    for _item in proto.area_callback_errors:
        ...
        convert_proto_to_bosdyn_msgs_area_callback_error(
            proto.area_callback_errors[_item], ros_msg.area_callback_errors[-1].value
        )
    ...
    for _item in proto.active_region_information:
        ...
        convert_proto_to_bosdyn_msgs_navigation_feedback_response_active_region_information(
            proto.active_region_information[_item], ros_msg.active_region_information[-1].value
        )
...
def convert_bosdyn_msgs_navigation_feedback_response_to_proto(ros_msg, proto):
    ...
    for _item in ros_msg.active_region_information:
        convert_bosdyn_msgs_navigation_feedback_response_active_region_information_to_proto(
            _item.value, proto.active_region_information[_item.key]
        )
...
def convert_proto_to_bosdyn_msgs_spot_check_feedback_response(proto, ros_msg):
    ...
    for _item in proto.camera_results:
        ...
        convert_proto_to_bosdyn_msgs_depth_plane_spot_check_result(
            proto.camera_results[_item], ros_msg.camera_results[-1].value
        )
    ...
    for _item in proto.load_cell_results:
        ...
        convert_proto_to_bosdyn_msgs_load_cell_spot_check_result(
            proto.load_cell_results[_item], ros_msg.load_cell_results[-1].value
        )
    ...
    for _item in proto.kinematic_cal_results:
        ...
        convert_proto_to_bosdyn_msgs_joint_kinematic_check_result(
            proto.kinematic_cal_results[_item], ros_msg.kinematic_cal_results[-1].value
        )
    ...
    for _item in proto.hip_range_of_motion_results:
        ...
        convert_proto_to_bosdyn_msgs_hip_range_of_motion_result(
            proto.hip_range_of_motion_results[_item], ros_msg.hip_range_of_motion_results[-1].value
        )
    ros_msg.progress = proto.progress
...
def convert_bosdyn_msgs_spot_check_feedback_response_to_proto(ros_msg, proto):
    ...
    for _item in ros_msg.hip_range_of_motion_results:
        convert_bosdyn_msgs_hip_range_of_motion_result_to_proto(
            _item.value, proto.hip_range_of_motion_results[_item.key]
        )
    proto.progress = ros_msg.progress
...
def convert_bosdyn_msgs_mobility_params_to_proto(ros_msg, proto):
    ...
    if ros_msg.external_force_params_is_set:
        convert_bosdyn_msgs_body_external_force_params_to_proto(
            ros_msg.external_force_params, proto.external_force_params
        )
...
def convert_proto_to_bosdyn_msgs_body_control_params_one_of_param(proto, ros_msg):
    ...
    if proto.HasField("body_assist_for_manipulation"):
        ...
        convert_proto_to_bosdyn_msgs_body_control_params_body_assist_for_manipulation(
            proto.body_assist_for_manipulation, ros_msg.body_assist_for_manipulation
        )
...
def convert_bosdyn_msgs_body_control_params_one_of_param_to_proto(ros_msg, proto):
    ...
    if ros_msg.param_choice == ros_msg.PARAM_BODY_ASSIST_FOR_MANIPULATION_SET:
        convert_bosdyn_msgs_body_control_params_body_assist_for_manipulation_to_proto(
            ros_msg.body_assist_for_manipulation, proto.body_assist_for_manipulation
        )
...
def convert_proto_to_bosdyn_msgs_door_command_request_one_of_command(proto, ros_msg):
    if proto.HasField("auto_grasp_command"):
        ...
        convert_proto_to_bosdyn_msgs_door_command_auto_grasp_command(
            proto.auto_grasp_command, ros_msg.auto_grasp_command
        )
...
def convert_bosdyn_msgs_door_command_request_one_of_command_to_proto(ros_msg, proto):
    ...
    if ros_msg.command_choice == ros_msg.COMMAND_AUTO_GRASP_COMMAND_SET:
        convert_bosdyn_msgs_door_command_auto_grasp_command_to_proto(
            ros_msg.auto_grasp_command, proto.auto_grasp_command
        )
...
def convert_proto_to_bosdyn_msgs_target_relocalize(proto, ros_msg):
    convert_proto_to_bosdyn_msgs_set_localization_request(
        proto.set_localization_request, ros_msg.set_localization_request
    )
...
def convert_bosdyn_msgs_target_relocalize_to_proto(ros_msg, proto):
    ...
    if ros_msg.set_localization_request_is_set:
        convert_bosdyn_msgs_set_localization_request_to_proto(
            ros_msg.set_localization_request, proto.set_localization_request
        )
...
def convert_proto_to_bosdyn_msgs_action_wrapper_arm_sensor_pointing(proto, ros_msg):
    ...
    convert_proto_to_bosdyn_msgs_body_control_params_body_assist_for_manipulation(
        proto.body_assist_params, ros_msg.body_assist_params
    )
...
def convert_bosdyn_msgs_action_wrapper_arm_sensor_pointing_to_proto(ros_msg, proto):
    ...
    if ros_msg.body_assist_params_is_set:
        convert_bosdyn_msgs_body_control_params_body_assist_for_manipulation_to_proto(
            ros_msg.body_assist_params, proto.body_assist_params
        )
...
def convert_proto_to_bosdyn_msgs_action_wrapper(proto, ros_msg):
    ...
    convert_proto_to_bosdyn_msgs_action_wrapper_arm_sensor_pointing(
        proto.arm_sensor_pointing, ros_msg.arm_sensor_pointing
    )
    ros_msg.arm_sensor_pointing_is_set = proto.HasField("arm_sensor_pointing")
    convert_proto_to_bosdyn_msgs_action_wrapper_gripper_camera_params(
        proto.gripper_camera_params, ros_msg.gripper_camera_params
    )
...
def convert_bosdyn_msgs_action_wrapper_to_proto(ros_msg, proto):
    ...
    if ros_msg.arm_sensor_pointing_is_set:
        convert_bosdyn_msgs_action_wrapper_arm_sensor_pointing_to_proto(
            ros_msg.arm_sensor_pointing, proto.arm_sensor_pointing
        )
    if ros_msg.gripper_camera_params_is_set:
        convert_bosdyn_msgs_action_wrapper_gripper_camera_params_to_proto(
            ros_msg.gripper_camera_params, proto.gripper_camera_params
        )
    if ros_msg.gripper_command_is_set:
...
def convert_proto_to_bosdyn_msgs_failure_behavior_one_of_default_behavior(proto, ros_msg):
    ...
    if proto.HasField("return_to_start_and_try_again_later"):
        ...
        convert_proto_to_bosdyn_msgs_failure_behavior_return_to_start_and_try_again_later(
            proto.return_to_start_and_try_again_later, ros_msg.return_to_start_and_try_again_later
        )
    if proto.HasField("return_to_start_and_terminate"):
        ...
        convert_proto_to_bosdyn_msgs_failure_behavior_return_to_start_and_terminate(
            proto.return_to_start_and_terminate, ros_msg.return_to_start_and_terminate
        )
...
def convert_bosdyn_msgs_failure_behavior_one_of_default_behavior_to_proto(ros_msg, proto):
    ...
    if ros_msg.default_behavior_choice == ros_msg.DEFAULT_BEHAVIOR_RETURN_TO_START_AND_TRY_AGAIN_LATER_SET:
        convert_bosdyn_msgs_failure_behavior_return_to_start_and_try_again_later_to_proto(
            ros_msg.return_to_start_and_try_again_later, proto.return_to_start_and_try_again_later
        )
    if ros_msg.default_behavior_choice == ros_msg.DEFAULT_BEHAVIOR_RETURN_TO_START_AND_TERMINATE_SET:
        convert_bosdyn_msgs_failure_behavior_return_to_start_and_terminate_to_proto(
            ros_msg.return_to_start_and_terminate, proto.return_to_start_and_terminate
        )
